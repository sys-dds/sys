      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-5 divide-y divide-line border-y border-line">
          {sections.map((section, index) => (
            <article key={section.title} className="grid gap-4 py-4 md:grid-cols-[4rem_0.75fr_1.25fr] md:items-start">
        ...
        <div className="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {interviewSignals.map((signal) => (
              <div key={signal} className="border-l border-line bg-surface/40 px-3 py-2.5 text-sm font-semibold text-mist">
                {signal}
              </div>
            ))}
          </div>
      ...
      <section className="border-b border-line bg-panel/40">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-bold leading-tight text-white">What £19 is buying.</h2>
          </div>
          <div className="text-base leading-7 text-mist">
            <p>
      ...
      <section className="border-b border-line bg-panel/20">
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-2xl font-bold text-white">Built as personal senior-interview study notes</h2>
            <p className="mt-4 text-base leading-7 text-mist">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Link href="/notes" className="rounded-md bg-white px-5 py-2.5 text-center text-sm font-bold text-ink">
                Browse notes
              </Link>
              <Link href="/roadmap" className="rounded-md border border-line px-5 py-2.5 text-center text-sm font-bold text-white">
                View roadmap
              </Link>
            </div>
          </div>
