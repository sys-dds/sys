...
export function CourseSidebar({ notes, activeSlug }: CourseSidebarProps) {
  return (
    <aside className="lg:sticky lg:top-20 lg:pr-2">
      <div>
      ...
      <nav className="mt-5 space-y-1 border-l border-line/70 pl-3" aria-label="Frontend System Design notes">
        {notes.map((note) => (
      ...
      <div className="mt-7 border-t border-line/60 pt-5">
        ...
        <div className="mt-3 space-y-1">
          {plannedTracks.map((track) => (
            <div key={track} className="flex items-center justify-between gap-3 py-1.5">
